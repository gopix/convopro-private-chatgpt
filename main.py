...
from convopro_private_chatgpt.services.get_models_list import get_openai_models_list
from convopro_private_chatgpt.services.get_title import get_chat_title
from convopro_private_chatgpt.services.chat_utilities import get_answer
from convopro_private_chatgpt.db.conversations import (
...
st.set_page_config(page_title="ConvoPro ChatGPT", page_icon="💬", layout="centered")
st.title("🤖 ConvoPro Chat")

# ---- Models ----
if "OPENAI_MODELS" not in st.session_state:
    st.session_state.OPENAI_MODELS = get_openai_models_list()

selected_model = st.selectbox("Select Model", st.session_state.OPENAI_MODELS)
